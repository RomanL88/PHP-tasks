...
for ($i=0; $i < $count; $i++) { 
    ...
    $boringToys[$i] = [                 
        ...
        'nameToy'  => 'Toy number = ' . $i, /* "Toy number = $i" */    //Название игрушки: в виде "Игрушка 1"
...
///////////////////////////////////////////////////////////////   ЗАДАНИЕ 2 РЕШАЮ ЧЕРЕЗ FOREACH      ///////////////////////////////////////////////////////////////////

foreach ($cars as $obj) {

    foreach ($obj as $obj2){
  
          if (is_int($obj2) or is_float($obj2)){
...
print_r( 'Price for cars = ' . $allCarsSum);
echo '<br>';
...
echo 'Купите автомобиль ' . $cars[$x]['name'] . ' цвета ' . $cars[$x]['colors']['color'][$x]  . ' всего за: ' .  $cars[$x]['colors']['upSale'] . ' руб' . '<br>';
